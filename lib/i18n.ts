...
export type Tr = {
  ...
  orderPage: {
    ...
    addonSub: string
    addonNone: string
    addonCustomOrder: string
    earlyBirdIneligible: string
  }
  orderSuccess: {
    title: string
    sub: string
...
export const t: Record<Lang, Tr> = {
  id: {
    ...
    orderPage: {
      ...
      confirmSub: 'Siap diproses! Kalau ada pertanyaan soal layanan ini, kamu bisa konsultasi dulu via WA sebelum bayar. Atau langsung gasken bayar sekarang! 🚀',
      ...
      addonTitle: 'Tambahan Nama Tamu Personal (Opsional)',
      addonSub: 'Link undangan dibuat personal untuk masing-masing tamu. Bisa di-skip kalau tidak perlu.',
      addonNone: 'Tidak perlu, makasih',
      addonCustomOrder: 'Lebih dari 300 nama? Pakai Custom Order ya!',
      earlyBirdIneligible: 'Diskon Early Bird gak berlaku untuk paket ini ya. Pilih paket Aesthetic atau Sultan biar bisa dapat diskon!',
    },
    orderSuccess: {
    ...
    serviceModal: {
      ...
      digitalItems: ['Undangan Online, mulai Rp89.000', 'Landing Page, mulai Rp309.000'],
      digitalTagline: 'Buat tampilan digitalmu makin exist!',
      designName: 'Layanan Desain',
      designItems: ['Desain Instagram, mulai Rp50.000', 'Edit Foto, mulai Rp30.000'],
      ...
      digital: [
        {
          ...
          revisiNote: 'Revisi extra: Rp35.000/revisi (hasilnya tetep worth it kok!) · Add-on nama tamu personal tersedia',
        },
        {
          name: 'Landing Page',
          tiers: [
          ...
          tiers: [
            {
              ...
              period: 'per post',
              delivery: '1-2 hari',
              features: ['1 konten feed atau story', 'Feed & story bisa dikombinasi', 'Revisi 1x included'],
            },
            {
              name: 'Feed Pemula',
              price: 'Rp185.000',
              ...
              delivery: '3-4 hari',
              save: 'Hemat Rp65.000',
              features: ['5 konten feed & story', 'Feed & story bisa dikombinasi bebas', 'Hemat vs harga satuan', 'Revisi 1x per konten'],
            },
            {
              name: 'Feed Aesthetic',
              price: 'Rp309.000',
              ...
              delivery: '5-7 hari',
              highlighted: true,
              save: 'Hemat Rp191.000',
              features: ['10 konten feed & story', 'Feed & story bisa dikombinasi bebas', 'Revisi 2x per konten', 'Antrian prioritas'],
            },
            {
              name: 'Feed Sultan',
              price: 'Rp709.000',
              period: 'per bulan',
              delivery: 'Ongoing',
              features: ['20 desain per bulan', 'Feed & story bisa dikombinasi bebas', 'Tone & branding konsisten', 'Revisi 1x per konten', 'Antrian prioritas'],
            },
          ],
        },
        {
    ...
    promo: {
      earlyBird: {
        ...
        desc: 'Diskon 25% khusus 20 klien pertama. Yang dateng duluan, yang untung duluan!',
        badge: '🔥 PROMO AKTIF',
        cta: 'Klaim Sebelum Kehabisan',
        eligibleLabel: '✅ Berlaku untuk:',
        eligibleItems: ['Undangan Aesthetic & Sultan', 'Halaman Kece & Sultan', 'Feed Pemula, Aesthetic & Sultan', 'Poles Banyak & Abis', 'Semua Paket Bundling'],
        ineligibleLabel: '❌ Tidak berlaku untuk:',
        ineligibleItems: ['Undangan Simpel', 'Halaman Santuy', 'Satu Post Dulu', 'Poles Dikit'],
      },
      bundling: {
  ...
  en: {
    ...
    orderPage: {
      ...
      confirmSub: "All set! Have questions about this service? You can consult via WA first, or go ahead and pay now! 🚀",
      ...
      addonTitle: 'Personal Guest Name Add-on (Optional)',
      addonSub: 'Each invitation link is personalized per guest. Skip it if you do not need this.',
      addonNone: 'No thanks, skip',
      addonCustomOrder: 'Over 300 names? Use Custom Order instead!',
      earlyBirdIneligible: 'Early Bird discount does not apply to this package. Pick Aesthetic or Sultan to get the discount!',
    },
    orderSuccess: {
      title: 'Order Placed! 🎉',
    ...
    hero: {
      ...
      cardPrice: 'Starting from Rp30.000',
    ...
    serviceModal: {
      ...
      digitalItems: ['Online Invitation, from Rp89.000', 'Landing Page, from Rp309.000'],
      digitalTagline: 'Make your digital presence shine!',
      designName: 'Design Services',
      designItems: ['Instagram Design, from Rp50.000', 'Photo Edit, from Rp30.000'],
      ...
      digital: [
        {
          ...
          revisiNote: "Extra revision: Rp35.000/revision (still worth it tho!) · Personal guest name add-on available",
        },
        {
          name: 'Landing Page',
          tiers: [
          ...
          tiers: [
            {
              ...
              period: 'per post',
              delivery: '1-2 days',
              features: ['1 feed or story content', 'Mix feed & story freely', '1x revision included'],
            },
            {
              name: 'Starter Feed',
              price: 'Rp185.000',
              ...
              delivery: '3-4 days',
              save: 'Save Rp65.000',
              features: ['5 feed & story content', 'Mix feed & story freely', 'Save vs. single price', '1x revision per content'],
            },
            {
              name: 'Aesthetic Feed',
              price: 'Rp309.000',
              ...
              highlighted: true,
              save: 'Save Rp191.000',
              features: ['10 feed & story content', 'Mix feed & story freely', '2x revisions per content', 'Priority queue'],
            },
            {
              name: 'Sultan Feed',
              price: 'Rp709.000',
              period: 'per month',
              delivery: 'Ongoing',
              features: ['20 designs per month', 'Mix feed & story freely', 'Consistent tone & branding', '1x revision per content', 'Priority queue'],
            },
          ],
        },
        {
    ...
    promo: {
      earlyBird: {
        ...
        desc: "25% off for the first 20 clients only. First come, first served!",
        badge: '🔥 PROMO ACTIVE',
        cta: "Claim Before It's Gone",
        eligibleLabel: '✅ Eligible:',
        eligibleItems: ['Aesthetic & Sultan Invite', 'Kece & Sultan Page', 'Starter, Aesthetic & Sultan Feed', 'Full & Max Polish', 'All Bundle Packages'],
        ineligibleLabel: '❌ Not eligible:',
        ineligibleItems: ['Simple Invite', 'Chill Page', 'One Post First', 'Quick Polish'],
      },
      bundling: {
