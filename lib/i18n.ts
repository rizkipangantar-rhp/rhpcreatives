      ...
      items: [
        {
          ...
          text: 'Undangannya cantik banget seriusan 😭❤️ Semua tamu pada nanya buat di mana, gue langsung rekomenin RHP. Prosesnya cepet, revisinya sabar banget. Worth it parah!',
          rating: 5,
        },
        {
          initials: 'BF',
          ...
          text: 'Awalnya ragu mau bikin landing page, takut ribet dan mahal. Eh ternyata prosesnya gampang banget — tinggal kasih brief, langsung dieksekusi. Abis landing page live, WA langsung rame. Gak nyangka sefektif ini beneran.',
          rating: 5,
        },
        {
          initials: 'KP',
          ...
          text: 'Udah lama ngerasa feed IG gue berantakan tapi gak tau harus mulai dari mana. Pas cobain RHP, jujur di awal responnya agak lama (nungguin sekitar 2 jam-an), tapi begitu hasilnya keluar... aesthetic banget serius. Sekarang engagement naik dan sering ada yang DM nanya siapa yang buat feed gue 😄',
          rating: 4,
        },
        {
          initials: 'DA',
          ...
          text: 'Foto KTP lama gue literally horror show 😭 Sekarang abis di-poles sama RHP jadi keliatan normal dan bersih akhirnya wkwk. Recommended banget buat yang mau apply kerja atau urus berkas apapun!',
          rating: 5,
        },
        {
          initials: 'RK',
          ...
          text: 'Jualan online gue stagnan padahal produknya udah enak dan harganya masuk akal. Ternyata masalahnya di konten — abis pakai jasa desain RHP, follower naik dan order masuk tiap hari. No cap, ini investasi yang worth it banget buat bisnis kecil.',
          rating: 5,
        },
        {
          initials: 'FN',
          ...
          text: 'Flyer dan banner event kita selalu ke RHP. Pengerjaan cepet, harganya masuk akal, dan hasilnya gak pernah bikin kecewa. Udah jadi langganan tetap dan gak ada niat pindah ke tempat lain.',
          rating: 5,
        },
        {
          initials: 'MS',
          ...
          text: 'Buat nikahan adek gue, kita ambil paket Undangan Sultan. Hasilnya melebihi ekspektasi banget — ada galeri foto, musik latar yang bikin baper, animasinya smooth. Banyak tamu yang bilang undangannya fancy kayak artis. Makasih banyak RHP! 🙏✨',
          rating: 5,
        },
        {
          initials: 'RP',
          ...
          text: 'Dari awal brief sampai revisi akhir prosesnya mulus banget. Mereka ngerti maunya gue walau gue jelasnya agak gak jelas wkwk. Hasilnya profesional dan sesuai ekspektasi. Puas dan pasti balik lagi.',
          rating: 5,
        },
        {
          initials: 'AR',
          ...
          text: 'Pas mau apply kerja, foto formal gue jelek banget dan gak ada studio foto deket rumah. Abis diedit sama RHP, background rapi, tampilan bersih dan profesional. Alhamdulillah lolos interview dan HRD-nya langsung pujiin foto gue 😄',
          rating: 5,
        },
        {
          initials: 'HW',
          ...
          text: 'Desainnya bagus, konsisten sama branding yang gue mau, dan komunikasinya enak. Cuma kadang response WA-nya agak slow kalau weekend. Tapi overall puas banget sama hasilnya dan udah rekomenin ke beberapa temen.',
          rating: 4,
        },
      ],
    },
      ...
      items: [
        {
          ...
          text: 'The invitation was absolutely stunning 😭❤️ Every single guest asked who made it and I immediately recommended RHP. Fast, patient with revisions, worth every penny!',
          rating: 5,
        },
        {
          initials: 'BF',
          ...
          text: "I was honestly skeptical about getting a landing page — thought it'd be complicated and pricey. But the process was super smooth, just sent a brief and they handled the rest. Once it went live, my WhatsApp blew up. Didn't expect it to work that well honestly.",
          rating: 5,
        },
        {
          initials: 'KP',
          ...
          text: "My IG feed was a mess and I had no idea where to start. I'll be real — response was a bit slow at first (waited about 2 hours), but when the result came through... actually aesthetic. Engagement went up and now I get DMs asking who designs my feed 😄",
          rating: 4,
        },
        {
          initials: 'DA',
          ...
          text: "My old ID photo was literally a horror show 😭 After RHP fixed it up, it finally looks normal and clean lmao. Highly recommend for anyone who needs a photo for job apps or official documents!",
          rating: 5,
        },
        {
          initials: 'RK',
          ...
          text: "My sales were stuck even though my product is good. Turns out the content was the problem — after getting designs from RHP, followers grew and orders started coming in daily. No cap, this is genuinely a great investment for small businesses.",
          rating: 5,
        },
        {
          initials: 'FN',
          name: 'Fajar Nugroho',
          role: 'Event Organizer',
          text: "We always go to RHP for event flyers and banners. Fast, fair pricing, consistently great results. They're our go-to and we're not going anywhere else.",
          rating: 5,
        },
        {
          initials: 'MS',
          ...
          text: "Got the Sultan package for my sister's wedding. The result was beyond what we expected — photo gallery, music that hits right in the feels, smooth animations. So many guests said it looked like a celebrity wedding invite. Thank you RHP!! 🙏✨",
          rating: 5,
        },
        {
          initials: 'RP',
          name: 'Rizky Pratama',
          role: 'Freelancer, Landing Page',
          text: "From brief to final revision, everything was smooth. They understood what I wanted even when my explanation was kinda all over the place lol. End result was professional and exactly on point. Will definitely be back.",
          rating: 5,
        },
        {
          initials: 'AR',
          ...
          text: "Needed a proper formal photo for job applications and no studio nearby. RHP cleaned up the background and polished everything up. Landed the interview and the HR actually complimented my photo 😄",
          rating: 5,
        },
        {
          initials: 'HW',
          ...
          text: "Great design, consistent with my brand direction, and communication was easy. Only thing — WhatsApp response can be a bit slow on weekends. But overall very satisfied and I've already referred a few friends.",
          rating: 4,
        },
      ],
    },
