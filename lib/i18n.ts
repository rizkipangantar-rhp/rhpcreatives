...
export const t: Record<Lang, Tr> = {
  id: {
    ...
    profile: {
      ...
      referrerDesc: 'Dapat diskon 15% setiap kali orang yang kamu ajak melakukan order. Berlaku selamanya, bisa dipakai berkali-kali!',
    ...
    promo: {
      ...
      referral: {
        ...
        sub: 'Rekomenin RHP Creatives ke temen kamu. Mereka daftar pakai kode referral kamu di halaman register dan langsung dapat diskon 10%. Kamu? Dapat diskon 15% tiap kali mereka order. Berlaku selamanya, unlimited!',
        referrerTitle: 'Kamu yang Ngajak',
        referrerDiscount: '15%',
        referrerDesc: 'Dapat diskon 15% setiap kali teman yang kamu ajak melakukan order. Berlaku selamanya, bisa dipakai berkali-kali, no expiry!',
  ...
  en: {
    ...
    profile: {
      ...
      copyBtn: 'Copy Code',
      copied: 'Copied!',
      shareNote: "Share this code with your friends. They sign up with it and get 10% off their first order. You? Get 15% off every time they order. No expiry, unlimited!",
      shareWaBtn: 'Share with Friends',
      rewardLabel: 'Referral Rewards',
      referrerTitle: 'You (the one who shares)',
      referrerDesc: 'Get 15% off every time someone you invited places an order. Valid forever, no limits!',
    ...
    promo: {
      ...
      referral: {
        ...
        sub: "Recommend RHP Creatives to your friend. They sign up with your referral code on the register page and get 10% off their first order. You? Get 15% off every time they order. No expiry, unlimited!",
        referrerTitle: 'You (the One Who Shares)',
        referrerDiscount: '15%',
        referrerDesc: "Get 15% off every time someone you invited places an order. Valid forever, no limits!",
        inviteeTitle: 'Your Friend (the Lucky One)',
